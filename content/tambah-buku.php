...
if (isset($_POST['tambah'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO buku (nama_buku, penerbit, tahun_terbit, pengarang, id_kategori) VALUES('$nama_buku', '$nama_penerbit', '$tahun_terbit', '$pengarang', '$id_kategori')");
                    ...
                    <div class="mb-3">
                        ...
                        <select name="id_kategori" id="" class="form-control">
                            ...
                            <?php while ($rowKategori = mysqli_fetch_assoc($queryKategori)): ?>
                                <option <?php echo isset($_GET['edit']) ? ($rowKategori['id'] == $rowEdit['id_kategori'] ? 'selected' : '') : '' ?> value="<?php echo $rowKategori['id'] ?>"><?php echo $rowKategori['nama_kategori'] ?></option> <?php endwhile ?>
                        </select>
                    </div>
                    <div class="mb-3">
